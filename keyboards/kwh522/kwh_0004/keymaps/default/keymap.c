...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, \
     ...
     */
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______,   UG_TOGG, UG_NEXT, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______,   UG_HUEU, UG_SATU, _______, _______, MS_BTN1, MS_UP,   MS_BTN2, _______, \
        _______, _______, _______, _______, _______, _______,   UG_VALU, UG_SPDU, _______, MS_WHLU, MS_LEFT, MS_DOWN, MS_RGHT, \
        _______, _______, _______, _______, _______,            _______, _______, _______, _______, MS_WHLD, _______, _______, _______, \
