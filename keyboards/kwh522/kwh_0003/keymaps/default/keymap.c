...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        JP_CAPS, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, KC_UP,   _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______, \
        _______, _______, _______, _______, _______,          _______, _______, KC_END,  KC_PGDN, KC_DOWN, _______, _______, _______, \
        _______, _______, KC_LGUI, _______, _______, _______, _______, _______, KC_APP,  _______, _______, _______ \
    ),
    /* Layer 2
     * ┌─────┬─────┬─────┬─────┬─────┬─────┐  ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
     * │     │     │     │     │     │     │  │TOGG │NEXT │     │     │     │     │     │     │     │
     ...
     */
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______,   UG_TOGG, UG_NEXT, _______, _______, _______, _______, _______, _______, KC_DEL, \
        _______, _______, _______, _______, _______, _______,   UG_HUEU, UG_SATU, _______, _______, MS_BTN1, MS_UP,   MS_BTN2, _______, \
        _______, _______, _______, _______, _______, _______,   UG_VALU, UG_SPDU, _______, MS_WHLU, MS_LEFT, MS_RGHT, _______, \
        _______, _______, _______, _______, _______,            _______, _______, _______, MS_WHLD, MS_DOWN, _______, _______, _______, \
...
bool oled_task_user(void) {
    ...
    if (layer != last_layer || caps != last_caps) {
        ...
        oled_write_P(PSTR("Tzolkin v.2.0"), false);
